		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Schedules",
									"targetURL": "#comlab2devschedulesbtpexp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devschedulesbtpexp-display": {
								"semanticObject": "comlab2devschedulesbtpexp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.schedulesbtpexp",
									"url": sap.ui.require.toUrl("com/lab2dev/schedulesbtpexp")
								}
							}
						}
					}
